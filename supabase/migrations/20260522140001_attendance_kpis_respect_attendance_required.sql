-- Exclude attendance-exempt employees (attendance_required = false) from KPI denominators and absent lists.
...
COMMENT ON FUNCTION attendance_kpis_filtered IS 'KPIs de asistencia. Excluye empleados con attendance_required = false.';
...
COMMENT ON FUNCTION attendance_lists_filtered IS 'Lista empleados por tipo de asistencia. Excluye attendance_required = false.';
