-- Migration: Fix attendance KPIs calculation logic
-- Date: 2025-09-04
-- Description: Implement correct logic for calculating Presentes, Ausentes, Tempranos, Tardes

-- 1. Crear función attendance_kpis_filtered que falta
...
-- 2. Actualizar función attendance_lists_filtered para consistencia
...
-- 3. Otorgar permisos
GRANT EXECUTE ON FUNCTION attendance_kpis_filtered(UUID, TEXT, TEXT, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION attendance_lists_filtered(UUID, TEXT, TEXT, TEXT, TEXT) TO authenticated;

-- 4. Comentarios para documentación
COMMENT ON FUNCTION attendance_kpis_filtered IS 'Calcula KPIs de asistencia con la lógica correcta: Presentes=todos con check-in, Tempranos=>5min antes, Tarde=>5min después, Ausentes=sin check-in';
COMMENT ON FUNCTION attendance_lists_filtered IS 'Lista empleados filtrados por tipo de asistencia con la lógica correcta';
