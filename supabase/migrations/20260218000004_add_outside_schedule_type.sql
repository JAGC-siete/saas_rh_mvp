-- Migration: Add outside_schedule type to attendance_lists_filtered
-- Date: 2026-02-18
-- Description: Allow filtering employees who marked outside expected schedule (Capa Base / horario_no_detectado).
...
COMMENT ON FUNCTION attendance_lists_filtered IS 'Lista empleados filtrados por tipo de asistencia. Incluye outside_schedule para marcas fuera de horario (Capa Base).';
