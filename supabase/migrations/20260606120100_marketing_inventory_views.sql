-- P0: Read-only inventory views for marketing vs legacy mail list (ops / pre-migration audit)
-- Legacy view is optional: mail_list_subscriptions may not exist on all environments.
