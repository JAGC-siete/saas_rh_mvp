...
export default function SuperAdminLayout({ children }: SuperAdminLayoutProps) {
  ...
  const superAdminNavigation = [
    ...
    { name: 'Mercado solicitudes', href: '/app/admin/mercado-solicitudes', icon: Store, description: 'Inscripciones Pickup /mercadosanpablosigua' },
    { name: 'Mercado fichas', href: '/app/admin/mercado-fichas', icon: Store, description: 'Fichas públicas del directorio Pickup' },
