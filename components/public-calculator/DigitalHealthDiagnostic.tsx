...
import { CalcRocketIcon, CalcWarningIcon } from './CalculatorUiIcons'
    ...
    <div className="glass rounded-xl p-5 border border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-orange-500/5">
      ...
      <ul className="space-y-3 text-sm">
        <li className="flex gap-2 text-brand-100">
          <CalcWarningIcon className="text-amber-400 mt-0.5" />
          <span>
        ...
        <li className="flex gap-2 text-brand-100">
          <CalcRocketIcon className="text-green-400 mt-0.5" />
          <span>
