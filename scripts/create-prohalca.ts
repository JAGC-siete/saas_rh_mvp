...
if (require.main === module) {
  createProhalcaCompany()
    .then(result => {
      ...
      console.log('🔑 Contraseña:', result.admin.password)
      console.log('🏢 Empresa:', result.company.name)
      console.log('🌐 Subdominio:', result.company.subdomain)
      console.log('👥 Departamentos:', result.departments)
      console.log('⏰ Horarios:', result.shifts)
      process.exit(0)
    })
    .catch(error => {
...
export default createProhalcaCompany
