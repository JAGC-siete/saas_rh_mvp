// ===============================================================================
// CORRECCIÓN: VALIDACIÓN DE API AUTH PARA SUPER ADMIN
// Archivo: lib/auth/api-auth-fixed.ts
// ===============================================================================
...
export interface AuthOptions {
  ...
  allowedRoles?: string[]
  allowSuperAdminWithoutCompany?: boolean // NUEVO
}
...
export async function authenticateUser(
  ...
  const { 
    ...
    requireAdmin = false, 
    allowedRoles = [],
    allowSuperAdminWithoutCompany = true // NUEVO: Permitir super_admin sin company_id
  } = options
...
export async function requireCompanyAccess(req: NextApiRequest, res: NextApiResponse): Promise<AuthenticatedUser> {
  ...
  // NUEVO: Permitir super_admin sin company_id
...
// 
// 1. Reemplazar import en APIs problemáticas:
//    OLD: import { requireCompanyAccess } from '../../../lib/auth/api-auth'
//    NEW: import { requireCompanyAccess } from '../../../lib/auth/api-auth-fixed'
// 
// 2. Para endpoints que necesitan company_id específico:
//    const auth = await requireCompanyAccess(req, res)
//    if (auth.role === 'super_admin') {
//      // Super admin puede acceder a cualquier company_id
//    } else {
//      // Otros roles solo a su company_id
//    }
// ===============================================================================
