...
import { Users, Plus, Settings, BarChart3, Clock, DollarSign, FileText, User, Calendar, Building2, LogOut } from 'lucide-react'
        ...
        <aside className="w-64 bg-white border-r border-gray-200 shadow-sm">
          ...
          <nav className="mt-6">
            <div className="px-3">
              ...
              <Link href="/employees" className="flex items-center gap-3 px-3 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg mb-1">
        ...
        <main className="flex-1 bg-gray-50">
          <header className="bg-white border-b border-gray-200 px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 mt-1">Gestión de empleados y personal</p>
              </div>
          ...
          <div className="p-6">
            <Card className="bg-white border border-gray-200">
              <CardHeader>
                <CardTitle className="text-lg font-semibold text-gray-900">Lista de Empleados</CardTitle>
              ...
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-lg mb-2">No hay empleados registrados</p>
                  <p className="text-gray-400">Comienza agregando el primer empleado</p>
