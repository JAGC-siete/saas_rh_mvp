...
export default function DemoPin() {
  ...
  const isBlocked = blockedMinutes && blockedMinutes > 0
        ...
        <div className="max-w-md w-full space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="block w-full px-4 py-3 text-center text-2xl font-mono border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
                  autoComplete="off"
                  maxLength={4}
                />
              </div>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              © 2025 Humano SISU - Demo Interactivo
            </p>
          </div>
        </div>
      </div>
