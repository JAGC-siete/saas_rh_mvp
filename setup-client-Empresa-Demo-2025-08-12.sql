...
-- Empleados: 15
-- Departamentos: 3
-- Generado: 2025-08-12T22:15:05.469Z
-- =====================================================
...
BEGIN
    ...
    SELECT id INTO company_id FROM companies WHERE name = 'Empresa Demo' LIMIT 1;
    ...
    FOR i IN 1..3 LOOP
        ...
        VALUES (
            ...
            CASE 
                ...
                WHEN i = 9 THEN 'Administración'
                WHEN i = 10 THEN 'Compras'
                ELSE 'Departamento ' || i
            END,
            CASE 
                ...
                WHEN i = 9 THEN 'Administración general y soporte'
                WHEN i = 10 THEN 'Adquisiciones y gestión de proveedores'
        ...
        FOR j IN 1..5 LOOP
            ...
            VALUES (
                ...
                CASE 
                    ...
                    ELSE 'Apellido' || i
                END,
                'empleado' || emp_counter || '@empresa-demo.com',
    ...
    IF 0 > 0 THEN
        ...
        RAISE NOTICE 'Empleados restantes creados: %', 0;
    END IF;
    ...
    RAISE NOTICE 'Configuración completada exitosamente para % empleados en % departamentos', 15, 3;
END $$;
...
WHERE d.company_id = (SELECT id FROM companies WHERE name = 'Empresa Demo')
...
WHERE e.company_id = (SELECT id FROM companies WHERE name = 'Empresa Demo')
