...
-- Empleados: 20
-- Departamentos: 4
-- Generado: Tue Aug 12 16:15:13 CST 2025
-- =====================================================
...
BEGIN
    ...
    SELECT id INTO company_id FROM companies WHERE name = 'Empresa Test' LIMIT 1;
        ...
        FOR j IN 1..5 LOOP
            ...
            VALUES (
                ...
                CASE 
                    ...
                    ELSE 'Apellido' || i
                END,
                'empleado' || emp_counter || '@empresa-test.com',
    ...
    RAISE NOTICE 'Configuración completada exitosamente para % empleados en % departamentos', 20, 4;
END $$;
...
WHERE d.company_id = (SELECT id FROM companies WHERE name = 'Empresa Test')
...
WHERE e.company_id = (SELECT id FROM companies WHERE name = 'Empresa Test')
